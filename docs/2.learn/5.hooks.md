...
description: "Type-safe event hooks for monitoring, debugging, and observability with capitan integration"
author: zoobzio
...
See [CircuitBreaker reference](../5.reference/4.connectors/circuitbreaker.md) for details.
...
See [RateLimiter reference](../5.reference/4.connectors/ratelimiter.md) for details.
...
See [WorkerPool reference](../5.reference/4.connectors/workerpool.md) for details.
...
See [Retry reference](../5.reference/4.connectors/retry.md) for details.
...
See [Fallback reference](../5.reference/4.connectors/fallback.md) for details.
...
See [Timeout reference](../5.reference/4.connectors/timeout.md) for details.
...
See [Backoff reference](../5.reference/4.connectors/backoff.md) for details.
...
- [WorkerPool Reference](../5.reference/4.connectors/workerpool.md)
- [Retry Reference](../5.reference/4.connectors/retry.md)
- [Fallback Reference](../5.reference/4.connectors/fallback.md)
- [Timeout Reference](../5.reference/4.connectors/timeout.md)
- [Backoff Reference](../5.reference/4.connectors/backoff.md)
