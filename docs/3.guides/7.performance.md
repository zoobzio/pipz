...
description: "Techniques and strategies for building high-performance pipelines with minimal allocations and optimal resource usage"
author: zoobzio
...
- [Testing Guide](./6.testing.md) - Performance testing strategies
- [Best Practices](./5.best-practices.md) - Production optimization
- [Error Recovery](./8.safety-reliability.md) - Performance impact of error handling