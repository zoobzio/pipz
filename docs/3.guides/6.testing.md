...
func TestConcurrentIsolation(t *testing.T) {
    ...
    concurrent := pipz.NewConcurrent[TestData]("parallel",
        pipz.Effect("modify1", func(ctx context.Context, d TestData) error {
            d.Values[0] = 999
            return nil
        }),
        pipz.Effect("modify2", func(ctx context.Context, d TestData) error {
            d.Meta["new"] = "data"
            return nil
        }),
    )
...
func TestDynamicPipelineModification(t *testing.T) {
    ...
    seq.Push(pipz.Transform("step2", func(_ context.Context, s string) string {
        return s + "!"
    }))
    ...
    seq.After("step1", pipz.Transform("step1.5", func(_ context.Context, s string) string {
        return "[" + s + "]"
    }))
