---
title: "Handle"
description: "Provides error observation and handling capabilities for processors with cleanup and compensation patterns"
author: zoobzio
...
- [Fallback](../4.connectors/fallback.md) - For simple primary/backup patterns
- [Retry](../4.connectors/retry.md) - For retry logic
- [Switch](../4.connectors/switch.md) - Often used within error handlers
- [Concurrent](../4.connectors/concurrent.md) - For parallel error handling