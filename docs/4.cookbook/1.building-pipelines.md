---
title: "Recipe: Building Pipelines"
description: "Complete user registration pipeline with validation, enrichment, resilience, and observability"
author: zoobzio
...
- [Safety & Reliability](../3.guides/6.safety-reliability.md) - Error recovery patterns
- [Testing Pipelines](../3.guides/4.testing.md) - Comprehensive testing strategies
- [Performance](../3.guides/5.performance.md) - Optimization tips
- [Library Resilience](./2.library-resilience.md) - Expose resilience via With* API
- [Extensible Vocabulary](./3.extensible-vocabulary.md) - Create domain-specific APIs